...
import { FaTachometerAlt, FaTruck, FaClipboardList, FaBoxOpen, FaUsers, FaCalculator, FaMapMarkedAlt, FaFileInvoiceDollar, FaBell, FaChartBar, FaCog } from "react-icons/fa";
  ...
  return (
    <div className="sidebar">
      ...
      <nav className="sidebar-nav sidebar-scrollable">
        ...
        {/* <NavLink to="/support" className="sidebar-link"><FaLifeRing /> Support Tickets</NavLink> */}
